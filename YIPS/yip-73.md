...
### Rationale
The rationale is covered in the Motivation and Considerations sections above. The design uses oYFI and gauge-based emissions to align rewards with active governance participation, discourage passive farming, and extend buyback runway while prioritizing vault users.
...
### Configurable Values
See the "Configurable parameters" table in Section 6 above for the full list of adjustable parameters and defaults.
